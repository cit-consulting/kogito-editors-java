...
public class DoubleElement extends MetadataTypeDefinition<Double> {
    ...
    @Override
    public Double getValue(BaseElement element) {
    ...
    @Override
    public void setValue(BaseElement element, Double value) {
