...
@Dependent
public class IntegrationModeTrustSocialProvider implements SelectorDataProvider {

    private enum ADVANCE_AI_TYPE {
        V1(IntegrationModeTrustSocial.V1, "IntegrationModeTrustSocial.V1"),
        V1_PDL(IntegrationModeTrustSocial.V1_PDL, "IntegrationModeTrustSocial.V1_PDL");
    ...
    @Inject
    public IntegrationModeTrustSocialProvider(final TranslationService translationService) {
    ...
    protected void init() {
        ...
        valuePosition.put(ADVANCE_AI_TYPE.V1.value(), 0);
        valuePosition.put(ADVANCE_AI_TYPE.V1_PDL.value(), 1);
    }
    ...
    public SelectorData getSelectorData(final FormRenderingContext context) {
        ...
        return new SelectorData(values, ADVANCE_AI_TYPE.V1.value());
    }
}