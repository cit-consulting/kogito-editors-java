...
@Dependent
public class IntegrationModePhotoValidationProvider implements SelectorDataProvider {

    private enum ADVANCE_AI_TYPE {
        TEXT(IntegrationModePhotoValidation.TEXT, "IntegrationModePhotoValidation.TEXT"),
        LABELS(IntegrationModePhotoValidation.LABELS, "IntegrationModePhotoValidation.LABELS"),
        FACES(IntegrationModePhotoValidation.FACES, "IntegrationModePhotoValidation.FACES");

        private final String value;

        private final String i18nKey;

        ADVANCE_AI_TYPE(String value, String i18nKey) {
            this.value = value;
    ...
    @Inject
    public IntegrationModePhotoValidationProvider(final TranslationService translationService) {
    ...
    protected void init() {
        ...
        valuePosition.put(ADVANCE_AI_TYPE.TEXT.value(), 0);
        valuePosition.put(ADVANCE_AI_TYPE.LABELS.value(), 1);
        valuePosition.put(ADVANCE_AI_TYPE.FACES.value(), 2);
    }
