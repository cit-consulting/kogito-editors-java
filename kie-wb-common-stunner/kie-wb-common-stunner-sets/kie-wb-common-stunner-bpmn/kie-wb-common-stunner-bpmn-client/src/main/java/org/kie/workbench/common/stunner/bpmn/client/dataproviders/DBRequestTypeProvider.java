...
@Dependent
public class DBRequestTypeProvider implements SelectorDataProvider {
    ...
    private enum DATA_BASE {
        ...
        DATA_BASE(String value, String i18nKey) {
            this.value = value;
    ...
    @Inject
    public DBRequestTypeProvider(final TranslationService translationService) {
