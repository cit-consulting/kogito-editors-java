...
public class DragonPayTask extends BaseTask implements IntegrationTask {

    @Property
    @FormField(afterElement = "general")
    @Valid
    protected DragonPayTaskExecutionSet executionSet;

    public DragonPayTask() {
        this(
                new TaskGeneralSet(new Name("DragonPay Integration"), new Documentation("")),
    ...
    public DragonPayTask(
            ...
            final @MapsTo("executionSet") DragonPayTaskExecutionSet executionSet,
    ...
    public DragonPayTaskExecutionSet getExecutionSet() {
        return executionSet;
    }

    public void setExecutionSet(final DragonPayTaskExecutionSet executionSet) {
        this.executionSet = executionSet;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof DragonPayTask) {
            DragonPayTask other = (DragonPayTask) o;
