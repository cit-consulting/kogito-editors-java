...
package org.kie.workbench.common.stunner.bpmn.workitem.riskengine;
...
public class MyCustomTask extends BaseCustomTask implements DataIOModel {
    ...
    public static boolean isWorkItem(final Object definition) {
        return ClassUtils.isTypeOf(MyCustomTask.class,
                                   definition);
    }
    ...
    public MyCustomTask() {
        this("Custom Task",
             ...
             new SimulationSet(),
             new TaskType(TaskTypes.MY_CUSTOM));
    }

    public MyCustomTask(@MapsTo("name") String name,
    ...
    public boolean equals(Object o) {
        if (o instanceof MyCustomTask) {
            MyCustomTask other = (MyCustomTask) o;
