...
public class MBATaskExecutionSet implements BPMNPropertySet {
    ...
    private final IntegrationType integrationType = new IntegrationType(IntegrationType.MBA);

    private final String integrationIdentity = "mba-integration";

    public String getIntegrationIdentity() {
        return integrationIdentity;
    }

    public MBATaskExecutionSet() {
        this(0.0, "default");
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof MBATaskExecutionSet) {
            MBATaskExecutionSet other = (MBATaskExecutionSet) o;
