...
public class JuicyTask extends BaseTask implements IntegrationTask {

    @Property
    @FormField(afterElement = "general")
    @Valid
    protected JuicyTaskExecutionSet executionSet;

    public JuicyTask() {
        this(
                new TaskGeneralSet(new Name("Juicy Integration"), new Documentation("")),
                new JuicyTaskExecutionSet(),
                new BackgroundSet(),
                new FontSet(),
                new RectangleDimensionsSet(),
                new SimulationSet(),
                new TaskType(TaskTypes.JUICY)
        );
    }

    public JuicyTask(
            final @MapsTo("general") TaskGeneralSet general,
            final @MapsTo("executionSet") JuicyTaskExecutionSet executionSet,
    ...
    public JuicyTaskExecutionSet getExecutionSet() {
        return executionSet;
    }

    public void setExecutionSet(final JuicyTaskExecutionSet executionSet) {
        this.executionSet = executionSet;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof JuicyTask) {
            JuicyTask other = (JuicyTask) o;
