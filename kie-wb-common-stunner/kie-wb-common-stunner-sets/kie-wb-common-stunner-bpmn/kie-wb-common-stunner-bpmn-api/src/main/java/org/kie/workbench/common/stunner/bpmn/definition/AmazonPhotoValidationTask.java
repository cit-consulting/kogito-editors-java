...
public class AmazonPhotoValidationTask extends BaseTask implements IntegrationTask {
    ...
    public AmazonPhotoValidationTask() {
        this(new TaskGeneralSet(new Name("Amazon Photo Validation"), new Documentation("")),
             ...
             new SimulationSet(),
             new TaskType(TaskTypes.AMAZON_PHOTO_VALIDATION));
    }

    public AmazonPhotoValidationTask(final @MapsTo("general") TaskGeneralSet general,
                                     final @MapsTo("executionSet") AmazonPhotoValidationTaskExecutionSet executionSet,
    ...
    public AmazonPhotoValidationTaskExecutionSet getExecutionSet() {
        return executionSet;
    }

    public void setExecutionSet(final AmazonPhotoValidationTaskExecutionSet executionSet) {
        this.executionSet = executionSet;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof AmazonPhotoValidationTask) {
            AmazonPhotoValidationTask other = (AmazonPhotoValidationTask) o;
