...
public class SeonTask extends BaseTask implements IntegrationTask {

    @Property
    @FormField(afterElement = "general")
    @Valid
    protected SeonTaskExecutionSet executionSet;

    public SeonTask() {
        this(
                new TaskGeneralSet(new Name("Seon Integration"), new Documentation("")),
                new SeonTaskExecutionSet(),
                new BackgroundSet(),
                new FontSet(),
                new RectangleDimensionsSet(),
                new SimulationSet(),
                new TaskType(TaskTypes.SEON)
        );
    }

    public SeonTask(
            final @MapsTo("general") TaskGeneralSet general,
            final @MapsTo("executionSet") SeonTaskExecutionSet executionSet,
    ...
    public SeonTaskExecutionSet getExecutionSet() {
        return executionSet;
    }

    public void setExecutionSet(final SeonTaskExecutionSet executionSet) {
        this.executionSet = executionSet;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof SeonTask) {
            SeonTask other = (SeonTask) o;
