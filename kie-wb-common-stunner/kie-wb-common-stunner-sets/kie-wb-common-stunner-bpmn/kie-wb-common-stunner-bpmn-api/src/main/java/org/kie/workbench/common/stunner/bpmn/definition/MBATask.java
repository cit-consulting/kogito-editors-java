...
public class MBATask extends BaseTask implements IntegrationTask {

    @Property
    @FormField(afterElement = "general")
    @Valid
    protected MBATaskExecutionSet executionSet;

    public MBATask() {
        this(
                new TaskGeneralSet(new Name("MBA Integration"), new Documentation("")),
                new MBATaskExecutionSet(),
                new BackgroundSet(),
                new FontSet(),
                new RectangleDimensionsSet(),
                new SimulationSet(),
                new TaskType(TaskTypes.MBA)
        );
    }

    public MBATask(
            final @MapsTo("general") TaskGeneralSet general,
            final @MapsTo("executionSet") MBATaskExecutionSet executionSet,
    ...
    public MBATaskExecutionSet getExecutionSet() {
        return executionSet;
    }

    public void setExecutionSet(final MBATaskExecutionSet executionSet) {
        this.executionSet = executionSet;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof MBATask) {
            MBATask other = (MBATask) o;
